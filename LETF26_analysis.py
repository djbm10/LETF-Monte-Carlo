...
START_DATE = "1926-07-01"  # Fama-French daily data starts July 1926
END_DATE = "2025-12-31"
...
def fetch_historical_data():
    ...
    ff_data = fetch_fama_french_data(START_DATE, FAMA_FRENCH_END_DATE)
    ...
    try:
        data = yf.download(tickers, start=YFINANCE_START_DATE, end=END_DATE, 
