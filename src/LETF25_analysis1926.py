...
# ========================================================================
    ...
    spy_returns = fat_tailed_returns['SPY_Ret']
    qqq_returns_raw = fat_tailed_returns['QQQ_Ret']
    tlt_returns_raw = fat_tailed_returns['TLT_Ret']
    
    # Override VIX with bootstrap values if available
    # (but we'll still use the AR(1) dynamics below for consistency)
